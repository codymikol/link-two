...
function loadMaps() {
    environmentMap[0] = JSON.parse(map_1);
    environmentMap[1] = JSON.parse(map_2);
    environmentMap[2] = JSON.parse(map_3);
    environmentMap[3] = JSON.parse(map_4);
    environmentMap[4] = JSON.parse(map_5);
    environmentMap[5] = JSON.parse(map_6);
    environmentMap[6] = JSON.parse(map_7);
    environmentMap[7] = JSON.parse(map_8);
